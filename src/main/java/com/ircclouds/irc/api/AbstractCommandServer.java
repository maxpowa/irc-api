...
public abstract class AbstractCommandServer implements ICommandServer, INeedsConnection
{
	private static final Logger LOG = LoggerFactory.getLogger(AbstractCommandServer.class);
